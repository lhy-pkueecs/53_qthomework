...
struct qt_meta_stringdata_CLASStimetableENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASStimetableENDCLASS = QtMocHelpers::stringData(
    "timetable",
...
Q_CONSTINIT static const uint qt_meta_data_CLASStimetableENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject timetable::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASStimetableENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASStimetableENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASStimetableENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<timetable, std::true_type>,
...
void *timetable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASStimetableENDCLASS.stringdata0))
